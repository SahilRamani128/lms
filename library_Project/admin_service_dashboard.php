...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="Physio"/>Physio<input type="radio" name="branch" value="BSCIT"/>BSCIT<div style="margin-left:80px"><input type="radio" name="branch" value="CGPIT"/>CGPIT<input type="radio" name="branch" value="AMTICS"/>AMTICS</div>
            </div>   
